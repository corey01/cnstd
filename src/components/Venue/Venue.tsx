...
const Venue = () => {
    return (
        ...
        <div className={style.body}>
            ...
            <p>Falcon manor is an elegant country house perched on the edge of Settle, overlooking the Yorkshire dales.</p>
            </div>
            <BrushRevealImage image='venue.png' strokes={4} duration={4} />
        </div>
        <div className={style.body} style={{ flexDirection: 'column-reverse' }}>
        <BrushRevealImage image='settle.png' strokes={4} duration={4} />
